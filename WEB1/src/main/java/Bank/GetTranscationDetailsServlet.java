...
@WebServlet("/GetTransactionDetailsServlet")LECT_TRANSACTION_QUERY = "SELECT * FROM transaction WHERE account_no = ?";
public class GetTranscationDetailsServlet extends HttpServlet {
